...
class TicketForm(forms.ModelForm):
    ...
    numero_ticket_externo = forms.CharField(
        label="Número de Orden de Trabajo",
        required=False,
        max_length=50,
        widget=forms.TextInput(attrs={
            'placeholder': 'Opcional: Ingrese el número de orden...'
        })
    )
    ...
    class Meta:
        ...
        fields = ['herramienta', 'ubicacion', 'falla', 'comentarios', 'tacto', 'operacion', 'numero_ticket_externo']
        widgets = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        # --- Aplicar estilos oscuros a todos los campos ---
        for field_name, field in self.fields.items():
            existing_class = field.widget.attrs.get('class', '')
            field.widget.attrs['class'] = f"{existing_class} bg-dark text-white border-secondary".strip()
        ...
        self.helper.layout = Layout(
            ...
            HTML('<hr>'),
            HTML('<h5 class="mb-3">4. Información Adicional</h5>'),
