...
¡Despliega la aplicación en minutos con nuestros scripts automatizados!
...
2.  Ejecuta:
    ...
    .\deploy.ps1
    ```
3.  Sigue las instrucciones en pantalla (Elige "Nativo" para portable o "Docker").
...
## 🛠️ Instalación Manual y Configuración
